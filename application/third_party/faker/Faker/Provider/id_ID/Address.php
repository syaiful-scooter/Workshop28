...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $street = array(
        ...
        "Bazuka Raya", "Bhayangkara", "Camar", "Casablanca", "Cemara", "Ciledug",
        ...
        "Pondok Kacang", "Pondok Bahar", "Pondok Kacang Prima", "Pondok Betung",
        "Pondok Kopi", "Pondok Indah", "Pondok Pinang", "Pondok Lestari", "Pondok Gede",
    ...
    protected static $streetPrefix = array(
        "Ds.", "Gg.", "Jln.", "Komp.", "Gg.", "Jln.", "Kpg.", "Gg.", "Jln.",
        "Psr.","Gg.", "Jln.", "Blok","Gg.", "Jln."
    );
